  ...
  >
    <div className="max-w-5xl mx-auto px-4 py-32 text-center">
      ...
      <p className="text-lg md:text-2xl text-[var(--color-text-muted)] mb-8 max-w-3xl mx-auto">
        Donate your surplus food or reach out for help — it&apos;s easy, safe,
        and meaningful.
      </p>
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        ...
        <Link
          href="/login"
          className="bg-[var(--color-orange-light)] text-[var(--color-text-primary)] font-semibold py-3 px-6 rounded-full transition-colors"
        >
          I Need Food
        </Link>
      </div>
